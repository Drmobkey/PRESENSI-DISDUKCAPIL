<div class="py-1 text-sm-left">
    <a href="{{ url($url) }}" class="btn btn-tertiary d-inline-flex align-items-center" aria-haspopup="true"
        aria-expanded="false">
        <svg class="icon icon-sm me-2" fill="none" stroke="currentColor" viewBox="0 0 15 24"
