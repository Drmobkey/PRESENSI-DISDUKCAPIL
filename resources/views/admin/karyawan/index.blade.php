    ...
    <div class="main py-4">
        <div class="card card-body border-0 shadow table-wrapper table-responsive">
            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-auto">
                    <a href="{{ route('karyawans.create') }}" class="btn btn-gray-800 d-inline-flex align-items-center">
            ...
            <div id="user-table">
                @include('admin.karyawan.table', ['karyawans' => $karyawans])
            </div>
        </div>
    </div>
@endsection
...
@section('scripts')
    <script>
        document.getElementById('search').addEventListener('input', function() {
            ...
            fetch(`{{ route('karyawans.index') }}?search=${query}`, {
                    headers: {
